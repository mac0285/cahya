    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <center><?php echo $this->session->flashdata('msg');?></center>
                <h1 class="page-header">Datas
                    <small>Pengguna</small>
                    <div class="pull-right"><a href="#" class="btn btn-sm btn-success" data-toggle="modal" data-target="#largeModal"><span class="fa fa-plus"></span></a></div>
                </h1>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="modal fade" id="largeModal" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/pengguna/tambah_pengguna'?>">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Kode DC</label>
                        <div class="col-xs-9">
                            <select name="cabang" class="form-control" style="width:280px;" required>
                                <option value="QZ01" selected>Denpasar</option>
                                <option value="TZ01">Tangerang</option>
                                <option value="LZ01" selected>Lombok</option>
                                <option value="AZ01" selected>Kantor Pusat</option>
                            </select>
                        </div>
                    </div> 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            ...
                            <?php if ($cabang=='QZ01'):?>
                                ...
                                <option value="AZ01" selected>Kantor Pusat</option>
                            <?php else:?>
                                <option value="QZ01">Denpasar</option>
                                <option value="TZ01" selected>Tangerang</option>
                                <option value="LZ01" selected>Lombok</option>
                                <option value="AZ01" selected>Kantor Pusat</option>
                            <?php endif;?>
                            </select>
