...
<head>
    ...
    <meta name="description" content="Produk By SDT">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <center><?php echo $this->session->flashdata('msg');?></center>
                <h1 class="page-header">Transaksi
                    ...
                    <a href="#" data-toggle="modal" data-target="#largeModal" class="pull-right"><small ><button type="submit" class="btn btn-info btn-searching"> Cari</button></small></a>
                </h1> 
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            ...
            <table>
                ...
                <tr>
                    <th><input type="hidden" value="" name="kode_dc" id="kode_dc" class="form-control input-sm" disabled></th>                     
                </tr>
                <tr>
                    <th>Scan Barang</th>
                </tr>
